...
const defaultComponents = memoizeMarkdownComponents({
  ...
  // Sparkfeed override: links get the hover card (favicon, tidied URL, copy and
  // open actions) rather than a bare anchor. Falls back to a plain anchor for
  // in-page fragments, which have nothing useful to preview.
  a: ({ className, href, children, ...props }) =>
    href && !href.startsWith("#") ? (
      <SparkLink url={href}>{children}</SparkLink>
    ) : (
      <a
        href={href}
        className={cn(
