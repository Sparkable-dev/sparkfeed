...
function ToolFallbackTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-fallback-trigger group/trigger flex w-fit origin-left items-center gap-2 py-1.5 text-sm text-muted-foreground transition-[color,scale] hover:text-foreground active:scale-[0.98]",
        className
      )}
      {...props}
    >
